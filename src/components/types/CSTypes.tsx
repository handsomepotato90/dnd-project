...
export  default interface CSContextProps {
  ...
  notes: { ORGS: Notes[]; ALLIES: Notes[]; ENEMIES: Notes[]; TOWNS: Notes[]; OTHER: Notes[] };
  characteristics: Record<string, string>;
  stats: Record<string, { value: number; modifire?: number; proff: boolean }>;
  xp: number;
  skillsProf: Record<string, { value: boolean }>;
  backNapp: Record<string, string>;
  attunedItems: Record<string, string>;
  spellMods: Record<string, string>;
  currency: Record<string, string>;
  weapons: Weapon[];
  inventory: string;
  fullHeal: boolean;
  speed: number;
  otherProficiency: Record<string, string>;
  spells: Record<string, { slots: number; spells: any[]; spell_ids: any[] }>;
  ...
  newNote: (types: string, section: string, title: string, value: any, time: any, id: any) => void;
  backNApp: (title: string, text: string) => void;
  charData: (char: string, value: any) => void;
  otherInventory: (text: string) => void;
  attuneItem: (number: string, item: string) => void;
  currencyValue: (curr: string, value: string) => void
  spellmods: (mod: string, value: string) => void
  addWeapons: (type: string, range: string, hit: string, damage: string) => void;
  proff: (p: number) => void;
  ...
  setInspiration:(thp: number) => void;

  ...
  return (
    <div onClick={() => props.onClick(false)} className={styles.box_design}>
      ...
      <div className={styles.second_half}>
        ...
        {props.monsterStats["Legendary Actions"] && <Actions name="Legendary Actions" actions={props.monsterStats["Legendary Actions"]} />}
        {props.monsterStats.Reactions && <Actions name="Reactions" actions={props.monsterStats.Reactions} />}
      </div>
      
      <div className={styles.image_half}>
        {props.monsterStats.img_url && <img src={props.monsterStats.img_url} alt="monster"></img>}
        <div dangerouslySetInnerHTML={{ __html: props.monsterStats.Characteristics }}></div>
      </div>
    </div>
  );
}

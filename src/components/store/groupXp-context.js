...
export const GroupXpProvider = (props) =>{
    const sumOfAllXp = (array) => {
        ...
        const theChallengeLadder = { easy: easySum, medium: mediumSum ,hard : hardSum, deadly : deadlySum};
    ...
    return<GroupXp.Provider value = {{theChallengeLadder :theChallengeLadder , getPlayer:getPlayer ,players:players ,Deleter:Deleter}} > {props.children}</GroupXp.Provider>
} 
